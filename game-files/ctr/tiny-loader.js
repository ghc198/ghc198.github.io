!function e(t, n, r) {
    ...
    9: [function(e, t, n) {
        ...
        for (r in C)
            (o = (i = l[r]) && i.prototype) ? h(o, I, i) : M = !1;
        for (r in L)
            (o = (i = l[r]) && i.prototype) && h(o, I, i);
        ...
        M))
            for (r in C)
                l[r] && v(l[r], S);
        if ((!M || !O || O === P) && (O = S.prototype,
        M))
            for (r in C)
                l[r] && v(l[r].prototype, O);
        if (M && b(k) !== O && v(k, O),
        s && !f(O, E))
            for (r in _ = !0,
            g(O, E, {
    ...
    10: [function(e, t, n) {
        ...
        var r = e("../internals/global")
          ...
          , z = function(e, t, n, r, i, o) {
            ...
            if (a + t > s.byteLength)
                throw C(R);
            for (var l = k(s.buffer).bytes, c = a + s.byteOffset, u = r(+i), f = 0; f < t; f++)
                l[c + f] = u[o ? f : t - f - 1]
        };
        if (o) {
            var Y = j && E.name !== O;
            if (c((function() {
                ...
                ).prototype = E.prototype, X = b(E), J = 0; X.length > J; )
                    ($ = X[J++])in T || s(T, $, E[$]);
                H.constructor = T
            }
            g && y(M) !== _ && g(M, _);
    ...
    14: [function(e, t, n) {
        var r = Math.floor
          ...
          , a = function(e, t, n) {
            for (var r = e.length, i = t.length, o = 0, a = 0, s = []; o < r || a < i; )
                o < r && a < i ? s.push(n(e[o], t[a]) <= 0 ? e[o++] : t[a++]) : s.push(o < r ? e[o++] : t[a++]);
            return s
        };
        t.exports = i
    }
    ...
    15: [function(e, t, n) {
        ...
        t.exports = function(e) {
            ...
            (i(t) && (t === Array || r(t.prototype)) || o(t) && null === (t = t[a])) && (t = void 0)),
            void 0 === t ? Array : t
        }
    }
    , {
    ...
    25: [function(e, t, n) {
        ...
        t.exports = function(e, t, n, o, d, y, S) {
            ...
            }, T = t + " Iterator", I = !1, M = e.prototype, _ = M[w] || M["@@iterator"] || d && M[d], C = !m && _ || E(d), L = "Array" == t && M.entries || _;
            if (L && (O = l(L.call(new e))) !== Object.prototype && O.next && (i || l(O) === v || (c ? c(O, v) : a(O[w]) || p(O, w, k)),
            u(O, T, !0, !0),
            i && (h[T] = k)),
            g && d == j && _ && _.name !== j && (!i && b ? f(M, "name", j) : (I = !0,
            C = function() {
                return _.call(this)
            }
            )),
    ...
    36: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
            var n, u, f, p, d, h = e.target, y = e.global, g = e.stat;
            if (n = y ? r : g ? r[h] || s(h, {}) : (r[h] || {}).prototype)
                for (u in t) {
                    if (p = t[u],
                    f = e.noTargetGet ? (d = i(n, u)) && d.value : n[u],
                    !c(y ? u : h + (g ? "." : "#") + u, e.forced) && void 0 !== f) {
    ...
    51: [function(e, t, n) {
        ...
        t.exports = {
            pack: function(e, t, n) {
                var l, c, u, f = new Array(n), p = 8 * n - t - 1, d = (1 << p) - 1, h = d >> 1, y = 23 === t ? i(2, -24) - i(2, -77) : 0, g = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0, b = 0;
                for ((e = r(e)) != e || e === 1 / 0 ? (c = e != e ? 1 : 0,
                l = d) : (l = o(a(e) / s),
                e * (u = i(2, -l)) < 1 && (l--,
                u *= 2),
                (e += l + h >= 1 ? y / u : y * i(2, 1 - h)) * u >= 2 && (l++,
                u /= 2),
                l + h >= d ? (c = 0,
                l = d) : l + h >= 1 ? (c = (e * u - 1) * i(2, t),
            ...
            unpack: function(e, t) {
                var n, r = e.length, o = 8 * r - t - 1, a = (1 << o) - 1, s = a >> 1, l = o - 7, c = r - 1, u = e[c--], f = 127 & u;
    ...
    55: [function(e, t, n) {
        var r, i, o, a = e("../internals/native-weak-map"), s = e("../internals/global"), l = e("../internals/is-object"), c = e("../internals/create-non-enumerable-property"), u = e("../internals/has-own-property"), f = e("../internals/shared-store"), p = e("../internals/shared-key"), d = e("../internals/hidden-keys"), h = "Object already initialized", y = s.WeakMap;
        if (a || f.state) {
    ...
    65: [function(e, t, n) {
        "use strict";
        var r, i, o, a = e("../internals/fails"), s = e("../internals/is-callable"), l = e("../internals/object-create"), c = e("../internals/object-get-prototype-of"), u = e("../internals/redefine"), f = e("../internals/well-known-symbol"), p = e("../internals/is-pure"), d = f("iterator"), h = !1;
    ...
    70: [function(e, t, n) {
        var r, i = e("../internals/an-object"), o = e("../internals/object-define-properties"), a = e("../internals/enum-bug-keys"), s = e("../internals/hidden-keys"), l = e("../internals/html"), c = e("../internals/document-create-element"), u = e("../internals/shared-key"), f = u("IE_PROTO"), p = function() {}, d = function(e) {
            ...
            var e, t;
            y = "undefined" != typeof document ? document.domain && r ? h(r) : ((t = c("iframe")).style.display = "none",
            l.appendChild(t),
    ...
    84: [function(e, t, n) {
        ...
        (t.exports = function(e, t, n, l) {
            var c, f = !!l && !!l.unsafe, h = !!l && !!l.enumerable, y = !!l && !!l.noTargetGet, g = l && void 0 !== l.name ? l.name : t;
            ...
            e !== r ? (f ? !y && e[t] && (h = !0) : delete e[t],
            h ? e[t] = n : a(e, t, n)) : h ? e[t] = n : s(t, n)
        }
    ...
    86: [function(e, t, n) {
        "use strict";
        var r, i, o = e("../internals/to-string"), a = e("../internals/regexp-flags"), s = e("../internals/regexp-sticky-helpers"), l = e("../internals/shared"), c = e("../internals/object-create"), u = e("../internals/internal-state").get, f = e("../internals/regexp-unsupported-dot-all"), p = e("../internals/regexp-unsupported-ncg"), d = RegExp.prototype.exec, h = l("native-string-replace", String.prototype.replace), y = d, g = (r = /a/,
        i = /b*/g,
        d.call(r, "a"),
        d.call(i, "a"),
        0 !== r.lastIndex || 0 !== i.lastIndex), b = s.UNSUPPORTED_Y || s.BROKEN_CARET, v = void 0 !== /()??/.exec("")[1];
        (g || v || b || f || p) && (y = function(e) {
            var t, n, r, i, s, l, f, p = this, m = u(p), w = o(e), x = m.raw;
            if (x)
            ...
            var j = m.groups
              ...
              , O = 0
              , P = w;
            if (A && (-1 === (k = k.replace("y", "")).indexOf("g") && (k += "g"),
            ...
            g && (r = p.lastIndex),
            i = d.call(A ? n : p, P),
            A ? i ? (i.input = i.input.slice(O),
            i[0] = i[0].slice(O),
            i.index = p.lastIndex,
            p.lastIndex += i[0].length) : p.lastIndex = 0 : g && i && (p.lastIndex = p.global ? i.index + i[0].length : r),
            v && i && i.length > 1 && h.call(i[0], n, (function() {
    ...
    98: [function(e, t, n) {
        var r = e("../internals/to-integer-or-infinity")
          ...
          , a = function(e) {
            return function(t, n) {
                var a, s, l = i(o(t)), c = r(n), u = l.length;
    ...
    112: [function(e, t, n) {
        ...
        var r = e("../internals/export")
          ...
          , $ = "Wrong length"
          , H = function(e, t) {
            for (var n = 0, r = t.length, i = new (G(e))(r); r > n; )
                i[n] = t[n++];
            return i
        }
          , X = function(e, t) {
          ...
          , Q = function(e, t, n) {
            return t = g(t),
            !(K(e, t) && m(n) && b(n, "value")) || b(n, "get") || b(n, "set") || n.configurable || b(n, "writable") && !n.writable || b(n, "enumerable") && !n.enumerable ? _(e, t, n) : (e[t] = n.value,
            e)
        };
        o ? (F || (R.f = Z,
        P.f = Q,
        ...
        t.exports = function(e, t, n) {
            ...
            F ? a && (g = t((function(e, t, n, r) {
                return c(e, g, s),
                T(m(t) ? J(t) ? void 0 !== r ? new p(t,y(n, o),r) : void 0 !== n ? new p(t,y(n, o)) : new p(t) : z(t) ? H(g, t) : k.call(g, t) : new p(h(t)), e, g)
            }
            )),
            j && j(g, V),
            S(A(p), (function(e) {
    ...
    114: [function(e, t, n) {
        ...
        t.exports = function(e) {
            var t, n, f, p, d, h, y = r(this), g = i(e), b = arguments.length, v = b > 1 ? arguments[1] : void 0, m = void 0 !== v, w = s(g);
            if (w && !l(w))
                for (h = (d = a(g, w)).next,
                g = []; !(p = h.call(d)).done; )
                    g.push(p.value);
            for (m && b > 2 && (v = c(v, arguments[2], 2)),
            n = o(g),
            f = new (u(y))(n),
            t = 0; n > t; t++)
                f[t] = m ? v(g[t], t) : g[t];
    ...
    117: [function(e, t, n) {
        ...
        t.exports = function(e) {
            return o(c, e) && (s || "string" == typeof c[e]) || (s && o(u, e) ? c[e] = u[e] : c[e] = f("Symbol." + e)),
            c[e]
        }
    }
    , {
        ...
        r("replace", (function(e, t, n) {
            ...
            , function(e, i) {
                ...
                for (var A, k = "", S = 0, O = 0; O < x.length; O++) {
                    j = x[O];
                    for (var P = c(j[0]), R = g(b(s(j.index), p.length), 0), E = [], T = 1; T < j.length; T++)
                        E.push(void 0 === (A = j[T]) ? A : String(A));
                    var I = j.groups;
                    if (v) {
    ...
    129: [function(e, t, n) {
        ...
        n.isDevHost = function() {
            const e = /(.*)/.test(location.href);
            return location.href.indexOf("") >= 0 || function() {
    ...
    130: [function(e, t, n) {
        ...
        n.HostInfo = class {
            constructor() {
                ...
                this.systemInfo.screenHeight = n.height,
                this.systemInfo.screenWidth = n.width,
                this.systemInfo.deviceModel = this.getDeviceModel(this.systemInfo.mobile, this.systemInfo.gpu, navigator.userAgent, n)
            }
            ...
            caniuseTool(e, t, n) {
                return new Promise((r=>{
                    ...
                    i.loadResource)(a, "text").then((e=>(e !== t && console.error("ERR!", t, "is not supported by browser, but supported by game", o),
                    e === t))).catch((()=>!1))),
    ...
    133: [function(e, t, n) {
        ...
        n.loadResource = async function(e, t, n=(()=>{}
        ), r) {
            ...
            if (!i.ok || null == i.body)
                throw new Error("Invalid fetch response. Code: " + i.status + "status: " + i.statusText + " url: " + e);
    ...
    134: [function(e, t, n) {
        ...
        n.loadResource = void 0,
        n.loadResource = function(e, t, n=(()=>{}
        ), r, i="GET", o=null, a=null) {
    ...
    135: [function(e, t, n) {
        ...
        class p {
            ...
            log(...e) {
                (0,
                u.log)(this.startedAt, this.host.systemInfo.devHost || this.verbose, ...e)
            }
            loadResource(e, t, n) {
                return "response" === t ? (0,
